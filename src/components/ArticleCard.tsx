...
export function ArticleCard({ article }: ArticleCardProps) {
  return (
    <Link
      ...
      className="group flex flex-col justify-between rounded-2xl border border-[#E7E2DA] bg-[#FFFFFF] p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-[#DDD7CD] hover:shadow-md"
    >
      ...
      <div className="mt-5 flex items-center justify-between border-t border-[#F5F2EB] pt-3 text-xs font-semibold text-[#75726B] transition-colors group-hover:text-[#1A1815]">
        <span className="font-mono text-[11px]">Engineering Note</span>
